<x-layouts>
    ...
    <div class="justify-center items-center flex flex-col h-screen space-y-9">
        @if ($jobs->count() > 0)
            ...
            <div
                class="grid grid-flow-row gap-8 text-neutral-600 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 justify-center">
                @foreach ($jobs as $item)
                    <div class="relative mx-auto w-full max-w-sm pt-6">
                        <div class="relative inline-block w-full transform transition-transform duration-300 ease-in-out bg-blue-500  rounded-lg p-3">
                            <div class="relative flex h-60 justify-center overflow-hidden rounded-lg">
                                <div
                                    class="w-full h-full transform transition-transform duration-500 ease-in-out hover:scale-110">
                                    <img src="https://images.unsplash.com/photo-1591825729269-caeb344f6df2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"
                                        alt="" />
                                </div>
                                ...
                                <div class="absolute bottom-0 mb-3 flex justify-center">
                                    <div class="flex space-x-5 overflow-hidden rounded-lg bg-white/70 px-4 py-1 shadow">
                                        <p class="flex items-center font-medium text-gray-500">
                                            <svg class="mr-2 h-5 w-5 fill-current" xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 512 512">
                                                <path
                            ...
                            <div class="">
                                        ...
                                        <div class="relative">
                                            <div class="flex w-full gap-x-3">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30"
                                                    ...
                                                    <path
                                                        d="M14 3C12.895 3 12 3.895 12 5L4 5C2.895 5 2 5.895 2 7L2 16C2 17.105 2.895 18 4 18L15.082031 18C16.468031 15.613 19.046 14 22 14C24.334 14 26.430531 15.011328 27.894531 16.611328C27.956531 16.417328 28 16.214 28 16L28 7C28 5.895 27.105 5 26 5L18 5C18 3.895 17.105 3 16 3L14 3 z M 15 14C15.552 14 16 14.448 16 15C16 15.552 15.552 16 15 16C14.448 16 14 15.552 14 15C14 14.448 14.448 14 15 14 z M 22 16C18.698136 16 16 18.698136 16 22C16 25.301864 18.698136 28 22 28C23.291499 28 24.487316 27.583068 25.46875 26.882812L28.292969 29.707031 A 1.0001 1.0001 0 1 0 29.707031 28.292969L26.882812 25.46875C27.583068 24.487316 28 23.291499 28 22C28 18.698136 25.301864 16 22 16 z M 22 18C24.220984 18 26 19.779016 26 22C26 24.220984 24.220984 26 22 26C19.779016 26 18 24.220984 18 22C18 19.779016 19.779016 18 22 18 z M 2 19.443359L2 23C2 24.105 2.895 25 4 25L14.589844 25C14.212844 24.073 14 23.061 14 22C14 21.308 14.098672 20.641 14.263672 20L4 20C3.268 20 2.591 19.787359 2 19.443359 z" />
                                                </svg>
                                                <h2 class="flex-auto text-base font-medium text-gray-800 md:text-lg">
                                                    {{ $item->job->name }}</h2>
                                            </div>
                                            <div class="mt-2 grid grid-cols-2 grid-rows-2 gap-2 border-b border-t border-gray-200 pb-3 pt-3">
                                                <p class="flex items-center text-gray-800 xl:flex-row xl:items-center">
                                                    <svg class="mr-3 inline-block w-7 h-7 fill-white text-gray-800 xl:h-6 xl:w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50"><path d="M8 2L8 6L4 6L4 48L15 48L15 39L19 39L19 48L30 48L30 6L26 6L26 2 Z M 10 10L12 10L12 12L10 12 Z M 14 10L16 10L16 12L14 12 Z M 18 10L20 10L20 12L18 12 Z M 22 10L24 10L24 12L22 12 Z M 32 14L32 18L34 18L34 20L32 20L32 22L34 22L34 24L32 24L32 26L34 26L34 28L32 28L32 30L34 30L34 32L32 32L32 34L34 34L34 36L32 36L32 38L34 38L34 40L32 40L32 42L34 42L34 44L32 44L32 48L46 48L46 14 Z M 10 15L12 15L12 19L10 19 Z M 14 15L16 15L16 19L14 19 Z M 18 15L20 15L20 19L18 19 Z M 22 15L24 15L24 19L22 19 Z M 36 18L38 18L38 20L36 20 Z M 40 18L42 18L42 20L40 20 Z M 10 21L12 21L12 25L10 25 Z M 14 21L16 21L16 25L14 25 Z M 18 21L20 21L20 25L18 25 Z M 22 21L24 21L24 25L22 25 Z M 36 22L38 22L38 24L36 24 Z M 40 22L42 22L42 24L40 24 Z M 36 26L38 26L38 28L36 28 Z M 40 26L42 26L42 28L40 28 Z M 10 27L12 27L12 31L10 31 Z M 14 27L16 27L16 31L14 31 Z M 18 27L20 27L20 31L18 31 Z M 22 27L24 27L24 31L22 31 Z M 36 30L38 30L38 32L36 32 Z M 40 30L42 30L42 32L40 32 Z M 10 33L12 33L12 37L10 37 Z M 14 33L16 33L16 37L14 37 Z M 18 33L20 33L20 37L18 37 Z M 22 33L24 33L24 37L22 37 Z M 36 34L38 34L38 36L36 36 Z M 40 34L42 34L42 36L40 36 Z M 36 38L38 38L38 40L36 40 Z M 40 38L42 38L42 40L40 40 Z M 10 39L12 39L12 44L10 44 Z M 22 39L24 39L24 44L22 44 Z M 36 42L38 42L38 44L36 44 Z M 40 42L42 42L42 44L40 44Z"/></svg>
                                                    <span class="mt-0">{{ $item->Organisation->name }}</span>
                                                </p>
                                                <p class="flex items-center text-gray-800 xl:flex-row xl:items-center">
                                                    <svg class="mr-3 inline-block w-7 h-7 fill-white text-gray-800 xl:h-6 xl:w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50"><path d="M7 2L7 48L43 48L43 14.59375L30.40625 2 Z M 30 4.40625L40.59375 15L30 15 Z M 14 10L27 10L27 12L14 12 Z M 14 14L27 14L27 16L14 16 Z M 14 18L37 18L37 20L14 20 Z M 14 22L37 22L37 24L14 24 Z M 14 26L37 26L37 28L14 28 Z M 20.15625 30.5625C21.875 30.5625 22.96875 31.746094 22.96875 33.59375C22.96875 35.632813 22.078125 37.441406 21.03125 38.84375C23.328125 38.660156 24.320313 36.9375 25 35.78125C25.414063 35.074219 25.78125 34.46875 26.53125 34.46875C27.527344 34.46875 27.855469 35.511719 28.21875 36.59375C28.230469 36.621094 28.238281 36.65625 28.25 36.6875C28.425781 36.550781 28.625 36.375 28.78125 36.25C29.769531 35.457031 31.003906 34.46875 32.5 34.46875C33.054688 34.46875 33.5 34.914063 33.5 35.46875C33.5 36.023438 33.054688 36.46875 32.5 36.46875C31.707031 36.46875 30.816406 37.183594 30.03125 37.8125C29.25 38.4375 28.585938 39 27.8125 39C26.976563 39 26.675781 38.257813 26.375 37.375C25.496094 38.78125 23.855469 40.875 20.59375 40.875C20.167969 40.875 19.800781 40.792969 19.4375 40.65625C18.699219 41.371094 18.097656 41.792969 18.03125 41.84375C17.855469 41.972656 17.671875 42.03125 17.46875 42.03125C17.160156 42.03125 16.851563 41.894531 16.65625 41.625C16.332031 41.179688 16.429688 40.542969 16.875 40.21875C16.886719 40.210938 17.25 39.925781 17.78125 39.4375C16.910156 38.367188 16.46875 36.878906 16.46875 35.65625C16.46875 32.890625 18.160156 30.5625 20.15625 30.5625 Z M 20.15625 32.5625C19.496094 32.5625 18.46875 33.886719 18.46875 35.65625C18.46875 36.367188 18.734375 37.265625 19.1875 37.9375C20.121094 36.765625 20.96875 35.25 20.96875 33.59375C20.96875 32.554688 20.445313 32.5625 20.15625 32.5625Z"/></svg>
                                                    <span class="mt-0">{{ $item->arrangement->type }}</span>
                                                </p>
                                                <p class="flex items-center text-gray-800 xl:flex-row xl:items-center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50"
                                                        class="fill-white w-7 h-7 mr-3">
                                                        <path
                                                    ...
                                                    <span
                                                        class="xl:mt-0">{{ ucwords($item->city) }} , @foreach ($world->countries(['fields'=>'iso2', 'filters'=>['name'=>$item->country]])->data as $iso2)
                                                            {{ $iso2['iso2'] }}
                                                        @endforeach</span>
                                                </p>
                                                <p class="flex items-center text-gray-800 xl:flex-row xl:items-center">
                                                    <svg class="mr-3 inline-block h-5 w-5 fill-white text-gray-800 xl:h-4 xl:w-4"
                                ...
                                <div class="mt-2 border-gray-200 line-clamp-3">{{ $item->description }}</div>

                                <div
                                    class="mt-2 grid grid-cols-2 grid-rows-2 gap-4 border-b border-t border-gray-200 pb-3 pt-3">
                                    <p class="flex items-center text-gray-800 xl:flex-row xl:items-center">
                                        <svg class="mr-3 inline-block h-5 w-5 fill-current text-gray-800 xl:h-4 xl:w-4"
