                        ...
                        <div class="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-8 "
                            ...
                            <div class="col-span-1 space-y-6">
                                <div class="w-full bg-gray-600 rounded-md">
                                    <div class="p-1">
                                        <div class="shadow rounded h-10 flex p-1 gap-2 relative items-center bg-gray-400">
                                            <div class="w-full flex justify-center">
                                                <a href="" @click.prevent="tab='resume'" class="bg-none hover:bg-none"
                                                    :class="{
                                                        'elSwitch bg-white shadow text-gray-800 flex items-center justify-center w-1/2 rounded h-8 transition-all top-[4px] absolute left-1': tab ==
                                                            'resume'
                                                    }">Resume
                                                </a>
                                            </div>
                                    ...
                                    <div class="grid grid-cols-2 gap-5" x-show="tab==='resume'">
                                        <div class="p-3">
                                            <img src="{{ asset('images/resume2.png') }}" alt=""
                                    ...
                                    <div class="grid grid-cols-2 gap-5" x-show="tab==='letter'">
                                        <div class="p-3">
                                            <img src="{{ asset('images/letter1.png') }}" alt=""
                                ...
                                {{-- <div class=""">
                                    <div class="">
                                        <x-button-link href="#"">Template</x-button-link>
                                        <x-button-link href="#" >Sections</x-button-link>
                                    </div>
                                    <div class="">
                                        <div class="" ">
                                            <p>
                                ...
                                <div class="" x-show="tab==='resume'">
                                    <div class="w-full bg-gray-600 rounded-md" x-data="{ tab2: 'template' }">
                                        <div class="p-1">
                                            <div class="shadow rounded h-10 flex p-1 relative items-center bg-gray-400">
                                                <div class="w-full flex justify-center">
                                                    <a href="#" @click.prevent="tab2='template'"
                                                        class="bg-none hover:bg-none"
                                                        :class="{
                                                            'elSwitch bg-white shadow text-gray-800 flex items-center justify-center w-1/2 rounded h-8 transition-all top-[4px] absolute left-1': tab2 ==
                                                                'template'
                                                        }">Template
                                                    </a>
                                                </div>
                                        ...
                                        <div class="grid grid-cols-2 gap-0.5" x-show="tab2==='section'">
                                                ...
                                                <x-button-link href="{{ URL::to('resume/create') }}"
                                                    ...
                                                    <div class="mx-auto p-2">
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            class="fill-white h-14 mx-auto" viewBox="0 0 32 32">
                                                            <path
                                            ...
                                            <div class="col-span-1 text-center m-1">
                                                <x-button-link
                                                    href="{{ URL::to('resume/education/' . $resume->id . '/show') }}"
                                                    class="bg-blue-500 hover:bg-blue-400 rounded flex">
                                                    <div class="mx-auto p-2">
                                                        <div class="">
                                            ...
                                            <div class="col-span-1 text-center m-1">
                                                <x-button-link href="{{ URL::to('resume/skill/create') }}"
                                                    ...
                                                    <div class="mx-auto p-2">
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            class="fill-white h-14 w-14" viewBox="0 0 26 26">
                                                            <path
                                            ...
                                            <div class="col-span-1 text-center m-1">
                                                <x-button-link
                                                    href="{{ URL::to('resume/referral/' . $resume->id . '/show') }}"
                                                    class="bg-blue-500 hover:bg-blue-400 rounded flex">
                                                    <div class="mx-auto p-2">
                                                        <div class="">
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            class="w-14 h-14 fill-white" viewBox="0 0 24 24">
                                                            <path
                                            ...
                                            <div class="col-span-1 text-center m-1">
                                                <x-button-link href="{{ URL::to('resume') }}"
                                                    ...
                                                    <div class="mx-auto p-2">
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            class="fill-white w-14 h-14" viewBox="0 0 30 30">
                                                            <path
                                        ...
                                        <div class="grid grid-cols-2 gap-2" x-show="tab2==='template'">
                                            <div class="col-span-1">
                                                <div class="p-3">
                                                    <img src="{{ asset('images/resume6.png') }}" alt=""
                                                        class="h-40 w- full rounded-md">
                                                </div>
                                            </div>
                                            <div class="col-span-1">
                                                <div class="p-3">
                                                    <img src="{{ asset('images/resume3.png') }}" alt=""
                                                        class="h-40 rounded-md">
                                                </div>
                                            </div>
                                            <div class="col-span-1">
                                                <div class="p-3">
                                                    <img src="{{ asset('images/resume4.png') }}" alt=""
                                                        class="h-40 rounded-md">
                                                </div>
                                            </div>
                                            <div class="col-span-1">
                                                <div class="p-3">
                                                    <img src="{{ asset('images/resume5.png') }}" alt=""
                                                        class="h-40 rounded-md">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="" x-show="tab==='letter'">
                                    <div class="w-full bg-blue-600 rounded-md" x-data="{ tab2: 'template' }">
                                        <div class="p-1">
                                            <div class="shadow rounded h-10 flex p-1 relative items-center bg-gray-400">
                                                <div class="w-full flex justify-center">
                                                    <a href="#" @click.prevent="tab2='template'"
                                        ...
                                        <div class="grid grid-cols-2 gap-0.5" x-show="tab2==='section'">
                                            ...
                                            <div class="col-span-1 text-center m-1">
                                                <x-button-link href="{{ URL::to('resume/create') }}"
                                                    ...
                                                    <div class="mx-auto p-2">
                                                        <div class="">
                                                            <span class="text-base text-white ">Organisation Address</span>
                                                        </div>
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"
                                                            class="fill-white h-14 w-14 mx-auto">
                                                            <path
                                            ...
                                            <div class="col-span-1 text-center m-1">
                                                <x-button-link href="{{ URL::to('letter/create') }}"
                                                    ...
                                                    <div class="mx-auto p-2">
                                                        <div class="">
                                                            <span class="text-base text-white ">Letter</span>
                                                        </div>
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"
                                                            class="fill-white h-14 w-14 mx-auto">
                                                            <path
                                        ...
                                        <div class="grid grid-cols-2 gap-2" x-show="tab2==='template'">
                                            <div class="col-span-1">
                                                <div class="p-3">
                                                    <img src="{{ asset('images/letter2.png') }}" alt=""
                                                        class="h-40 w- full rounded-md">
                                                </div>
                                            </div>
                                            <div class="col-span-1">
                                                <div class="p-3">
                                                    <img src="{{ asset('images/letter3.jpeg') }}" alt=""
                                                        class="h-40 rounded-md">
                                                </div>
                                            </div>
                                            <div class="col-span-1">
                                                <div class="p-3">
                                                    <img src="{{ asset('images/letter3.png') }}" alt=""
                                                        class="h-40 rounded-md">
                                                </div>
                                            </div>
                                            <div class="col-span-1">
