                        ...
                        <div class="bg-white px-4 py-2 sm:p-3 sm:pb-2">
                            <div class="sm:flex sm:items-start">
                                <div class="text-center sm:mx-auto sm:mt-0 sm:text-left w-full">
                                    ...
                                    <x-form.text name="address" placeholder="Enter your Postal Address" class="my-4"/>
                                    <x-form.text name="phone_number" placeholder="Enter your Second Phone Number" class="my-4"/>
                                    <div class="mb-3">
                                        <div class="">
                                            <label for="district"
                                            ...
                                            <select name="district" id="district"
                                                ...
                                                <option value="">Please Select the district you are in.</option>
                                                @foreach ($district->data as $item)
                                                    <option value="{{ $item['name'] }}" @selected(old('district') == $item['name'])>
                                                        {{ ucwords($item['name']) }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <x-form.error name="district" />
                                    </div>
                                    <div class="mb-3">
                                        <div class="">
                                            <label for="country"
