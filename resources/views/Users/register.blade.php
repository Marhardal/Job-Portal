        ...
        <div class="max-w-3xl mx-auto">
            <form action="" method="post" class="">
                <div class="grid grid-cols-2 gap-8 mx-auto">
                    <x-form.input-area name="fname" placeholder="Enter First Name." />
                    <x-form.input-area name="sname" placeholder="Enter Surname." />
                    <x-form.input-date name="birth" placeholder="Enter your date of Birth" type="date" />
                    <div class="">
                        <label for="" class="pb-1 text-gray-500 text-md">Enter your Gender.</label>
                        <div class="grid grid-cols-3 my-3">
                            <x-form.input-checkbox name="gender" label="Male"/>
                            <x-form.input-checkbox name="gender" label="Female"/>
                        </div>
                    </div>
                    ...
                    <x-form.input-area name="usname" placeholder="Enter your username." />
                    <x-form.input-area name="pword" placeholder="Enter your Password Name." />
                    <x-form.input-area name="cpword" placeholder="Confirm your password." />
